                ...
                <form class="form-horizontal" method="POST" action="{{ route('admin.course.update', $course->id) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            @else
                                <input type="text" class="form-control" name="text" placeholder="Text" value="{{ $course->text }}">
                            @endif
                        </div>
                    </div><br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            @else
                                <input type="text" class="form-control" name="price" placeholder="Price" value="{{ $course->price }}">
                            @endif
                        </div>
                    </div><br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            @else
                                <input type="text" class="form-control" name="student_count" placeholder="Students" value="{{ $course->student_count }}">
                            @endif
                        </div>
                    </div><br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            @else
                                <input type="text" class="form-control" name="lesson_count" placeholder="Lessons" value="{{ $course->lesson_count }}">
                            @endif
                        </div>
                    </div><br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            @else
                                <input type="text" class="form-control" name="week_count" placeholder="Weeks" value="{{ $course->week_count }}">
                            @endif
                        </div>
                    </div><br/>
